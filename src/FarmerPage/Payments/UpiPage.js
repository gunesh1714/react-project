...
export default function UpiPage() {
  ...
  return (
    <div>
      <form style={divsty}>
        <h1 style={headsty} onMouseEnter={bigshad} onMouseLeave={smallshad}>UPI Details</h1>
        <input type='text' placeholder='UPI ID' style={boxsty}></input><br></br><br></br>
        <input type='text' placeholder='UPI PIN' style={boxsty}></input><br></br><br></br>
